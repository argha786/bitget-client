...
export default function AdminCardDataTable() {
  ...
  function createData(name, merchant, worldElite, classic, prime, titanium) {
    return {
      name,
      merchant,
      worldElite,
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.worldElite}</TableCell>
                      <TableCell align="right">{row.classic}</TableCell>
                      <TableCell align="right">{row.prime}</TableCell>
                      <TableCell align="right">{row.titanium}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
